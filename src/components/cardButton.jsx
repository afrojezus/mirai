...
export const PeopleButton = withStyles(styles, { withTheme: true })(({ classes, theme, actor, name: { first, last }, image, charImg, charOnClick, role, ...props }) => {
    return (
        <Grid
...
const CardButton = withStyles(styles, { withTheme: true })(({ classes, theme, ...props }) => (
