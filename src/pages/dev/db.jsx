		...
		return (
			<div>
				<TitleHeader
					...
					color="black"
					subtitle="Control everything in Mirai"
				/>
				<Root>
					<Container hasHeader>
						<MainCard>
							...
							>
								...
								<div>
									<Container>
										<Typography variant="title">Current collections</Typography>
										{collections ? (
											<SuperTable
										...
										<Container>
											<Column>
												...
												<Container>
													{feeds && (
														<SuperTable
															data={Object.values(feeds.public_feed)}
															typeof="feeds"
															type="f"
														/>
													)}
									...
									{feedTabVal === 1 ? (
										...
										>
											<List className={classes.editList}>
												{feeds &&
													Object.values(feeds.public_feed).map(feed => (
														<ListItem
															onClick={() =>
															...
															key={feed.id}
														>
															<ListItemText>{feed.name}</ListItemText>
														</ListItem>
													))}
