...
class DevPlayer extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                <Card style={{position: 'absolute', top: theme.spacing.unit * 8, left: theme.spacing.unit, zIndex: 1000, margin: theme.spacing.unit, minWidth: 300 }}>
                    ...
                    <CardContent>
                        ...
                        <Typography type={'body1'}>IsPlaying: {playing ? 'true' : 'false'}</Typography>
                        <Typography type={'body1'}>IsFullscreen: {fullscreen ? 'true' : 'false'}</Typography>
                        <Typography type={'body1'}>IsBuffering: {buffering ? 'true' : 'false'}</Typography>
                        <div style={{display: 'flex'}}>

                            <Typography style={{margin: 'auto'}}>Native controls</Typography>
                            <div style={{flex: 1}} />
                            <FormGroup>
                            <FormControlLabel
                                control={
                                    <Switch
                                        checked={native}
                                        onChange={() => this.setState({native: !this.state.native})}
                                    />
                                }
                            />
                        </FormGroup></div>
                        ...
                        >
                            <Button raised color={'accent'}>Open video</Button>
                        </Dropzone>
                        <TextField fullWidth value={source} onChange={(e) => this.setState({source: e.currentTarget.value, status: e.currentTarget.value}, () => this.playPause())} placeholder={'URL'} />
                    </CardContent>
                </Card>
                <CircularProgress
                ...
                />
                {!native ? <Card id="controls" className={classes.controlpanel}>
                    ...
                    onClick={e => this.setState({ menuEl: e.currentTarget })}
                    color="contrast"
                    style={{position: 'fixed', bottom: theme.spacing.unit * 4, right: theme.spacing.unit * 4}}
