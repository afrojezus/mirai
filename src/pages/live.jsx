...
import Aqua4 from '../assets/aqua4.gif'
    ...
    render () {
        ...
        return (
            <div className={classes.root}>
                ...
                <Icon.LiveTv className={classes.icon} />
                <M.Typography type='display3' className={classes.title}>Live</M.Typography>
                </div>
                </M.Grid>
            </div>
        )
...
export default M.withStyles(style)(Live);